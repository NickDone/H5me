...
!function ($) {
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            ...
            '<div class="fixed-table-pagination" style="margin-top: 30px;"></div>',
            '</div>',
            '</div>'].join(''));
    ...
    BootstrapTable.prototype.initToolbar = function () {
		...
		{
			$(sprintf('<div class="bars pull-%s"></div>', this.options.toolbarAlign)).appendTo(this.$toolbar).html($(this.options.toolbar));
		}
